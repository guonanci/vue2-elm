            ...
            <transition name="fadeBounce">
                <div class="specs_list" v-if="showSpecs">
                    ...
                    <section class="specs_details">
                        ...
                        <ul>
                            <li :key='itemIndex' v-for="(item, itemIndex) in choosedFoods.specifications[0].values" :class="{specs_activity: itemIndex == specsIndex}" @click="chooseSpecs(itemIndex)">
                                {{item}}
                            </li>
                        </ul>
                    </section>
...
<script>
    ...
    import {msiteAddress, shopDetails, foodMenu, getRatingList, ratingScores, ratingTags} from 'common/requests'
